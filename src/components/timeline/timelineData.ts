export const timelineData = [
    {
        ...
        description:
            "Formación en desarrollo web, bases de datos, frontend, backend y despliegue de aplicaciones.",
    },
    {
        period: "2024",
        title: "Prácticas en Hospital Universitario 12 de Octubre",
        description:
            "Prácticas profesionales en entorno sanitario, reforzando habilidades técnicas, documentación y adaptación a entornos reales de trabajo.",
    },
    {
        period: "2025",
        title: "Arquitecto de Soluciones en la Nube con AWS",
        description:
